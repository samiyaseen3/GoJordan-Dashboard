        ...
        <div class="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div class="grid md:grid-cols-2 gap-0">
                ...
                <div class="relative hidden md:block">
                    ...
                    <img src="{{asset('assets_userside/images/petra.jpg')}}" alt="Jordan Tourism" class="h-[400px] w-full object-cover">
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('user.login.submit') }}" class="space-y-4" id="loginForm">
                        ...
                        <p class="text-center text-gray-600 text-xs mt-4">
                            ...
                            <a href="{{ route('register') }}" class="text-orange-600 font-semibold hover:text-orange-700">Sign up now</a>
