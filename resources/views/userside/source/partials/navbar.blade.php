                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu Adventure" aria-labelledby="adventureDropdown" style="background-color: #000;">
                                @foreach(App\Models\Category::where('name', '!=', 'Private Tour')->get() as $category)
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('tours.category', $category->name) }}" style="color: #ffffff;">
                                    <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" class="dropdown-img">
                        ...
                        <li class="nav-item {{ request()->is('tours.category') ? 'active' : '' }}">
                            <a href="{{ route('tours.category', 'Private Tour') }}" class="nav-link">Private Tours</a>
                        </li>
